...
func (d MyInterfaceShouldBeFunMockDescriptorWith1Arg) And(a1 map[string]map[MyStruct]bool, opts ...cmp.Option) MyInterfaceShouldBeFunMockDescriptorWith2Args {
...
func (d MyInterfaceShouldBeFunMockDescriptorWith1Arg) AndMatching(match func(a1 map[string]map[MyStruct]bool) error) MyInterfaceShouldBeFunMockDescriptorWith2Args {
	prev := d.methodDesc.argValidator
	d.methodDesc.argValidator = func(got_a0 int, got_a1 map[string]map[MyStruct]bool, got_a2 []chan<- <-chan struct{}) []string {
		errMsgs := prev(got_a0, got_a1, got_a2)
...
// 
// It passes such passed values to a function that then returns the return values. 
func (d MyInterfaceShouldBeFunMockDescriptorWith3Args) ReturnsFrom(f func(a0 int, a1 map[string]map[MyStruct]bool, a2 []chan<- <-chan struct{}) (r0 int, r1 error)) MyInterfaceShouldBeFunMockDescriptorWithReturn {
	d.methodDesc.call = f
...
func (m _makegomock_MyInterfaceMockFromMocker) ShouldBeFun(a0 int, a1 map[string]map[MyStruct]bool, a2 ...chan<- <-chan struct{}) (r0 int, r1 error) {
